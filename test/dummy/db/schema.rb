...
ActiveRecord::Schema[7.1].define(version: 2024_01_19_144459) do
  create_table "atlas_engine_country_imports", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "atlas_engine_events", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "atlas_engine_post_addresses", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "source_id"
    t.string "locale"
  ...
  create_table "maintenance_tasks_runs", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
