...
# source://state_machines-activerecord//lib/state_machines/integrations/active_record/version.rb#1
module StateMachines; end

# source://state_machines-activerecord//lib/state_machines/integrations/active_record/version.rb#2
...
module StateMachines::Integrations::ActiveRecord
  ...
  #
  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#479
  def around_save(object); end

  # Generates the fully-qualifed column name for this machine's attribute
  #
  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#496
  def attribute_column; end

  # Creates a scope for finding records *with* a particular state or
  # states for the attribute
  #
  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#485
  def create_with_scope(name); end

  # Creates a scope for finding records *without* a particular state or
  # states for the attribute
  #
  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#491
  def create_without_scope(name); end

  # Uses around callbacks to run state events if using the :save hook
  #
  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#457
  def define_action_hook; end

  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#443
  def define_state_initializer; end

  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#512
  def locale_path; end
  ...
  # @return [Boolean]
  #
  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#432
  ...
  # (i.e. returns false).
  #
  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#504
  ...
  #
  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#519
  ...
  # @return [Boolean]
  #
  # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#526
  ...
  class << self
    ...
    #
    # source://state_machines-activerecord//lib/state_machines/integrations/active_record.rb#424
