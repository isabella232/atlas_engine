...
class Elastic::Transport::Client
  ...
  #
  # source://elastic-transport//lib/elastic/transport/client.rb#175
  ...
  # @return [Symbol]
  #
  # source://elastic-transport//lib/elastic/transport/client.rb#316
  ...
  # @return [Array<Hash>]
  #
  # source://elastic-transport//lib/elastic/transport/client.rb#249
  def __extract_hosts(hosts_config); end

  # source://elastic-transport//lib/elastic/transport/client.rb#265
  def __parse_host(host); end

  # source://elastic-transport//lib/elastic/transport/client.rb#229
