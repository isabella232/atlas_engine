...
class StatsD::Instrument::BatchedUDPSink::Buffer < ::Thread::SizedQueue
  # source://statsd-instrument//lib/statsd/instrument/batched_udp_sink.rb#65
  def inspect; end

  # source://statsd-instrument//lib/statsd/instrument/batched_udp_sink.rb#69
  def pop_nonblock; end

  # source://statsd-instrument//lib/statsd/instrument/batched_udp_sink.rb#59
...
# source://statsd-instrument//lib/statsd/instrument/batched_udp_sink.rb#76
class StatsD::Instrument::BatchedUDPSink::Dispatcher
  # @return [Dispatcher] a new instance of Dispatcher
  #
  # source://statsd-instrument//lib/statsd/instrument/batched_udp_sink.rb#77
  def initialize(host, port, buffer_capacity, thread_priority, max_packet_size); end

  # source://statsd-instrument//lib/statsd/instrument/batched_udp_sink.rb#88
  def <<(datagram); end

  # source://statsd-instrument//lib/statsd/instrument/batched_udp_sink.rb#98
  def shutdown(wait = T.unsafe(nil)); end

  private

  # source://statsd-instrument//lib/statsd/instrument/batched_udp_sink.rb#163
  def dispatch; end

  # source://statsd-instrument//lib/statsd/instrument/batched_udp_sink.rb#111
  def flush(blocking:); end

  # source://statsd-instrument//lib/statsd/instrument/batched_udp_sink.rb#175
  def report_error(error); end

  # source://statsd-instrument//lib/statsd/instrument/batched_udp_sink.rb#140
  def thread_healthcheck; end
end

# source://statsd-instrument//lib/statsd/instrument/batched_udp_sink.rb#109
...
class StatsD::Instrument::UDPSink
  ...
  # source://statsd-instrument//lib/statsd/instrument/udp_sink.rb#58
  def invalidate_socket; end

  # source://statsd-instrument//lib/statsd/instrument/udp_sink.rb#63
  def socket; end

  # source://statsd-instrument//lib/statsd/instrument/udp_sink.rb#71
